                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="thumbnail no-margin-bottom">
                                        ...
                                        <div class="caption">
                                            <h3 id="thumbnail-label">云塔交流群<a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
                                            <p>云塔系统交流QQ群：954152892</p>
                                            <p><a href="./product.php" class="btn btn-primary" role="button">添加产品</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
