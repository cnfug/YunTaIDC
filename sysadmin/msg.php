...
<title>提示信息-Powered by 云塔IDC系统</title>
<style>
body {
 margin: 0;
 padding: 0;
...
<div id="js-alert-box" class="alert-box">
 ...
 <a onclick="window.history.go(-1);" class="alert-btn" id="js-alert-btn" style="display:none">返回上一页</a>
 </div>
